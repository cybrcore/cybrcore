...
- [x] [cybrcolors v1.0](https://github.com/cybrcore/cybrcolors)
- [x] [cybrpapers v1.0](https://github.com/cybrcore/cybrpapers)
...
- **cybrpapers**
  - [x] Release v2.0: 3 new wallpepers, full desktop and mobile devices support
- **cybrcursors**
  - [ ] Release v1.0
...
- **cybrcore**
  ...
  - [ ] Screensaver(s)
- **cybrpapers**  
  - [ ] Release v3.0: 9 new light & dark wallpapers  
