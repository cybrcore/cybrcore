...
## Before contributing
- Read [Design Philosophy](./PHILOSOPHY.md) to understand the *why* and *how*  
- Read [AI Usage Disclosure](./AI_USAGE.md) to understand when and how to use AI  
...
## Getting Started
1. Fork this repository and [clone it locally](INSTALL.md#method-2-full-repository-power-users)
2. [Install prerequisites](INSTALL.md#prerequisites--setup)
...
- Use the [Issue Report Template](.github/ISSUE_TEMPLATE/issue_report.md)
...
2. Follow [Design Philosophy](./PHILOSOPHY.md)
